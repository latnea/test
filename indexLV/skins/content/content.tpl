	...
	<div id="content-about">
		...
		<div class="about-me1" >
			<p>
				...
				<h4> Mani sauc Matjuhins Aleksandrs, man 24 gadi un es dzivoju Maskava.
					Es darbojus veb-programmesana piemeram 1 gadu. </h3>
			 </p>
			 <br>


			<a  href="#" onclick="a1(); return false;" style="float:left;" >Kontaktet ar mani! </a>
			<div id="p2" style="float:left; height:50px; width:40px; display:none;">
					Numurs: 8 (915) 282 31 99
					Pasts: latnea@mail.ru
					Skype:sanjokokok
		...
		<div id="content-works">
				...
				<div class="works-1">
					<div style="float:left; width:48%; ">
						<h3 style="color:#000000;"> 1. Saits - kompanijas novelesanas sistema</h3>
				...
				<div class="works-2">
					...
					<div style=" float:left; width:44%; heiht:100%; margin-left:4%;">
						<h3 style="color:#000000;"> 2. Saits - majas atrasana</h3>
						<p>Сайт поиска домов в Москве и в МО. 
							...
							<br/>
						<a href="http://3dgo.esy.es">Skatit!</a>
					</div>
				</div>
				...
				<div class="works-3">
					<div style=" float:left; width:50%; heiht:100%;">
						<h3 style="color:#000000;"> 3. Saits - manas majas lapa</h3>
						...
						<br/>
						<a href="http://localhost/ll/sajt1/sajt3/index.php">Skatit!</a>
					</div>
