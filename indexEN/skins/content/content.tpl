	...
	<div id="content-about">
		...
		<div class="about-me1" >
			<p>
				...
				<h4> My name is Matjuhin Alexander, I'm 24 years old and living in the Moscow.
					I do my web-programming about 1 year. </h3>
			 </p>
			 <br>


			<a  href="#" onclick="a1(); return false;" style="float:left;" >Contact with me! </a>
			<div id="p2" style="float:left; height:50px; width:40px; display:none;">
					Number: 8 (915) 282 31 99
					Mail: latnea@mail.ru
					Skype:sanjokokok
		...
		<div id="content-works">
				...
				<div class="works-1">
					<div style="float:left; width:48%; ">
						<h3 style="color:#000000;"> 1. Site - 3D companies choosing system</h3>
				...
				<div class="works-2">
					...
					<div style=" float:left; width:44%; heiht:100%; margin-left:4%;">
						<h3 style="color:#000000;"> 2. Site - house searching</h3>
						<p>Сайт поиска домов в Москве и в МО. 
							...
							<br/>
						<a href="http://3dgo.esy.es">Looks throw!</a>
					</div>
				</div>
				...
				<div class="works-3">
					<div style=" float:left; width:50%; heiht:100%;">
						<h3 style="color:#000000;"> 3. Site - my homepage</h3>
						...
						<br/>
						<a href="http://localhost/ll/sajt1/sajt3/index.php">Looks throw!</a>
					</div>
